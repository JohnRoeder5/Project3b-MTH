...
Assessing the variance inflation factors to check for multicollinearity, it can be seen that this dataset does not exhibit multicollinearity. All of our vif values are within a reasonable range being under 5 to indicate that there is no multicollinearity. . 
